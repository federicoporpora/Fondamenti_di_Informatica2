...
public class Previsione {
	...
	public Previsione(String previsione, int valore, Set<SegnoZodiacale> segni) {
		if (previsione == null)
			throw new NullPointerException("previsione nulla");
		if (previsione.isEmpty())
			throw new IllegalArgumentException("previsione");
		if (valore < 0)
			throw new IllegalArgumentException("valore");
		if (segni == null)
			throw new NullPointerException("segni null");
	...
	public String toString() {
		return "Previsione [previsione=" + previsione + ", valore=" + valore + ", segni=" + segni + "]";
	}
