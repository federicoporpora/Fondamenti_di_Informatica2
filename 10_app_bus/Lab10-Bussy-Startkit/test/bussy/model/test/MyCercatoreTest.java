...
public class MyCercatoreTest {
	...
	void testIllegalArgVari() {
		assertThrows(IllegalArgumentException.class, () -> new MyCercatore(Collections.emptyMap()));
		assertThrows(NullPointerException.class, () -> new MyCercatore(null));
		assertThrows(NullPointerException.class, () -> cercatore.cercaPercorsi(null, "Prova", OptionalInt.of(45)));
		assertThrows(NullPointerException.class, () -> cercatore.cercaPercorsi("Prova", null, OptionalInt.of(45)));
		assertThrows(NullPointerException.class, () -> cercatore.cercaPercorsi("Prova", "Prova", null));
		assertThrows(IllegalArgumentException.class, () -> cercatore.cercaPercorsi("", "Prova", OptionalInt.of(45)));
		assertThrows(IllegalArgumentException.class, () -> cercatore.cercaPercorsi("Prova", "", OptionalInt.of(45)));
