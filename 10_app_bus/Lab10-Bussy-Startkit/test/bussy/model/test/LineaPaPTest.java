...
public class LineaPaPTest {
	...
	void testIllegalArg2B() {
		...
		assertThrows(NullPointerException.class, () -> new LineaPaP(null, mappa22));
		assertThrows(NullPointerException.class, () -> new LineaPaP("32", null));
		assertThrows(IllegalArgumentException.class, () -> new LineaPaP("32", Collections.emptyMap()));
	}
	@Test
	void testEquals() {
