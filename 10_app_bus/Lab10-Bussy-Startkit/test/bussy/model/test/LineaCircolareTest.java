...
public class LineaCircolareTest {
	...
	void testIllegalArgVari() {
		...
		assertThrows(NullPointerException.class, () -> new LineaCircolare(null, mappa32chiusa));
		assertThrows(NullPointerException.class, () -> new LineaCircolare("32", null));
		assertThrows(IllegalArgumentException.class, () -> new LineaCircolare("32", Collections.emptyMap()));
	}
	@Test
	void testEquals() {
