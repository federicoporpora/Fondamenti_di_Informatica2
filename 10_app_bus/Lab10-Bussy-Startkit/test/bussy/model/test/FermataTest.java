...
public class FermataTest {
	...
	void testIllegalArg2B() {
		assertThrows(NullPointerException.class, () -> new Fermata("42", null));
		assertThrows(IllegalArgumentException.class, () -> new Fermata("", "Aldeeneee"));
		assertThrows(NullPointerException.class, () -> new Fermata(null, "Porta porta"));
		assertThrows(NullPointerException.class, () -> new Fermata("", null));
